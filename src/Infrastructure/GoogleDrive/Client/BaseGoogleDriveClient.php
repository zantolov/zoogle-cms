...
namespace Zantolov\ZoogleCms\Infrastructure\GoogleDrive\Client;

use Google_Client;
use Google_Service_Docs;
use Google_Service_Drive;
use GuzzleHttp\Psr7\Response;
use Zantolov\ZoogleCms\Infrastructure\GoogleDrive\Configuration\Configuration;
...
class BaseGoogleDriveClient implements GoogleDriveClient
{
    ...
    public function getDoc(string $fileId): \Google_Service_Docs_Document
    {
        ...
        $file = $service->documents->get($fileId,);
